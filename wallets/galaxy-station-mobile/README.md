...
<p align="center" width="100%">
  <a href="https://github.com/hyperweb-io/cosmos-kit/actions/workflows/run-tests.yml">
   ...
   <a href="https://github.com/hyperweb-io/cosmos-kit/blob/main/wallets/galaxy-station-mobile/LICENSE"><img height="20" src="https://img.shields.io/badge/license-BSD%203--Clause%20Clear-blue.svg"></a>
   <a href="https://www.npmjs.com/package/@cosmos-kit/galaxy-station-mobile"><img height="20" src="https://img.shields.io/github/package-json/v/hyperweb-io/cosmos-kit?filename=wallets%galaxy-station-mobile%2Fpackage.json"></a>
</p>
...
@cosmos-kit/galaxy-station-mobile is the Galaxy Station mobile integration for CosmosKit.
